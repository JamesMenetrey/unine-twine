...
if (WAMR_BUILD_SGX EQUAL 1)
  ...
  message ("     SGX support enabled")
else ()
  add_definitions (-DWASM_ENABLE_SGX=0)
endif()
if (WAMR_BUILD_SGX_DISABLE_UNTRUSTED_CALLS EQUAL 1)
  add_definitions (-DWAMR_BUILD_SGX_DISABLE_UNTRUSTED_CALLS=1)
  message ("     SGX untrusted calls disabled")
else ()
  add_definitions (-DWAMR_BUILD_SGX_DISABLE_UNTRUSTED_CALLS=0)
  message ("     SGX untrusted calls enabled")
endif()