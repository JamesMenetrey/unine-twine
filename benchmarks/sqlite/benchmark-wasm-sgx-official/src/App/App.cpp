...
int main(int argc, char const *argv[])
{
    ...
    {
        std::cout << "Profiling is not supported." << std::endl;
        return 1;
    }
    ...
    ecall_benchmark(g_eid, wasm_buffer, wasm_buffer_len, database_type, number_of_write, number_of_read, must_print_memory_usage);
