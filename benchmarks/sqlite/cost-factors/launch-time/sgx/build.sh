...
DOCKER_SQLITE_IMAGE=unine_benchmark_sgx_lkl_sqlite_launch_time
...
docker build --build-arg INSTRUMENTATION_CALLBACKS=launch_time_callbacks -f $ROOT_DIR/../../../benchmark-sgx/Dockerfile -t $DOCKER_SQLITE_IMAGE $ROOT_DIR/../../..
