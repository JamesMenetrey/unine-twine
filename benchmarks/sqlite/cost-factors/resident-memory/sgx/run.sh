...
SGXLKL_HD_KEY=${SGX_LK_IMAGE_KEY} python3 $ROOT_DIR/process_communication.py /opt/sgx-lkl-nonrelease/bin/sgx-lkl-run-oe --hw-debug $ROOT_DIR/sgx-lkl-sqlite.img.dirty app "$@"